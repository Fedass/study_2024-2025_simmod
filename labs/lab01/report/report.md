...
![img1-1](images/img1.jpg)
> Создание директории и шаблона.
...
Сохранив изменения в отредактированном файле shablon.tcl и закрыв его, запустим симулятор командой `ns shablon.tcl`. Увидим пустую область моделирования, поскольку ещё не определены никакие объекты и действия.
...
![4-1](images/img9.jpg)
> Скрипт, создающий 7 узлов.

![4-2](images/img10.jpg)
> Запущенный процесс
...
![5-1](images/img11.jpg)
> Cкрипт, создающий круговую цепь из 5 узлов и еще одним узлом вне круга.

![5-2](images/img12.jpg)
> Запущенный процесс
